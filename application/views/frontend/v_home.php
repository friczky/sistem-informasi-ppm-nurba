                ...
                <div class="row">
                  ...
                  <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12">
                    <div class="images_box">
                      <figure><img src="<?= base_url()?>assets/frontend/images/img2.png"></figure>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="box_bg">
          <div class="box_bg_img">
            <div class="row">
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="box_my">
                  <figure><img src="<?= base_url()?>assets/frontend/images/my1.jpg"></figure>
                  <div class="overlay">
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="box_my">
                  <figure><img src="<?= base_url()?>assets/frontend/images/my2.jpg"></figure>
                  <div class="overlay">
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="box_my">
                  <figure><img src="<?= base_url()?>assets/frontend/images/my3.jpg"></figure>
                  <div class="overlay">
                    <h3>Skills</h3>
                    <p>It is a long established fact that a reader will be distracted by the readable content o</p>
                  </div>
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="box_my">
                  <figure><img src="<?= base_url()?>assets/frontend/images/my4.jpg"></figure>
                  <div class="overlay">
...
<div id="learn" class="learn">
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="learn_box">
          <figure><img src="<?= base_url()?>assets/frontend/images/img.jpg" alt="img"/></figure>
        </div>
      </div>
    </div>
  </div>
...
<div class="make">
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
        <div class="make_img">
          <figure><img src="<?= base_url()?>assets/frontend/images/make_img.jpg"></figure>
        </div>
      </div>
    </div>
  </div>
...
$this->load->view('frontend/komponen/footer');
?>
