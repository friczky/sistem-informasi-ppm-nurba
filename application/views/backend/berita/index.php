              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
										<a href="<?= base_url()?>dashboard/berita/edit/<?= $b->id_berita?>" class="btn btn-primary"><i class="fas fa-edit"></i> Edit</a>
										<a href="#" data-toggle="modal" class="btn btn-danger" data-target="#hapus<?= $b->id_berita?>">Hapus</a>
										...
										<div class="modal-dialog modal-lg">
											<div class="modal-content">
												...
												<div class="modal-body">
													Ingin menghapus berita : <?= $b->judul?>
												</div>
