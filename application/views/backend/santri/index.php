                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <div class="dropdown-menu" role="menu">
                      <a class="dropdown-item" href="<?= base_url()?>dashboard/santri/edit/1"><i class="fa fa-edit" aria-hidden="true"></i> Edit</a>
                      <a class="dropdown-item" href="<?= base_url()?>dashboard/santri/hapus/1?>"><i class="fas fa-trash"></i> Hapus</a>
                    </div>
