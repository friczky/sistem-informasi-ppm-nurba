            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label>Nama</label>
                  <input type="text" class="form-control" name="nama" placeholder="Masukan Nama Santri" required>
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="nama_wali" class="form-control" id="" placeholder="Masukan Nami Wali Santri">
                </div>
              </div>   
							<div class="col-md-6">
                <div class="form-group">
                  <label>No Hp</label>
                  <input type="text" class="form-control" name="telpon" placeholder="Masukan Nomer HP Whatsapp Santri" required>
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="telpon_wali" class="form-control" id="" placeholder="Masukan Nomer Hp atau Whatsapp Wali Santri">
                </div>
              </div> 
							<div class="col-md-6">
                <div class="form-group">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <label>Kampus</label>
                  <input type="text" class="form-control" name="kampus" placeholder="Masukan Asal Kampus" required>
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="angkatan" placeholder="Masukan Angkatan Pondok" id="" required>
                </div>
              </div>   
