            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label>Nama</label>
                  <input type="text" class="form-control" name="judul" placeholder="Masukan Nama Ustadz" required>
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <label>Alamat</label>
                  <input type="text" class="form-control" name="judul" placeholder="Masukan Alamat Ustadz" required>
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="" id="" placeholder="Masukan Nama Yang di Ajarkan">
                </div>
              </div>  
            </div>
			<!-- /.col -->
